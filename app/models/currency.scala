...
case object Currency extends PlayEnum[Currency] {
   ...
   case object XRP  extends Currency(description = "Ripple",
                                     currencyType = CryptoCurrency,
                                     isDivisor = false)
   case object BCH  extends Currency(description = "Bitcoin Cash",
                                     currencyType = CryptoCurrency,
                                     isDivisor = false)
   case object ADA  extends Currency(description = "Cardano",
                                     currencyType = CryptoCurrency,
                                     isDivisor = false)
   case object IOTA  extends Currency(description = "IOTA",
                                     currencyType = CryptoCurrency,
                                     isDivisor = false)
   case object LTC  extends Currency(description = "Litecoin",
                                     currencyType = CryptoCurrency,
                                     isDivisor = false)
